...
const Icons = () => {
  return (
    <>
      <div className="flex absolute gap-5 top-[74.5rem] left-[28rem] justify-start items-start rounded-[0.63rem] py-[18px] px-6 drop-shadow-xl [4px 4px 14px 0px #00000033] bg-[#FFFFFF] w-[364px] h-[84px]">
